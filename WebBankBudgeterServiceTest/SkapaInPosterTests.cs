...
namespace WebBankBudgeterServiceTest
{
    ...
    public class SkapaInPosterTests
    {
        ...
        public void TransFileExistsTest()
        {
            ...
            {
                Assert.Inconclusive(
                    $"Saknar transaktionsfil f�r M0-test: {_transactionTestFilePath}. " +
                    "Kopiera `pelles budget.xls` till testprojektets output (Data) eller k�r fr�n repo med filen i workspace.");
            }
        }
        ...
        public void DoubleToStringFormat_Test()
        {
            ...
            Assert.IsTrue(actual is "1\u00a0151" or "1 151", $"Ov�ntat format: {actual}");
        }
