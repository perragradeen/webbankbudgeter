    ...
    public class LoadNSave
    {
            ...
            Dictionary<string, string> saldon)
        {
            ...
            try
            {
                ...
                BackupOrginialFile("Before.Save", kontoutdragInfoForSave.excelFileSavePath
                    , kontoutdragInfoForSave.excelFileSavePathWithoutFileName, kontoutdragInfoForSave.excelFileSaveFileName);

                // spara över gammalt, innan skrevs det på sist
                Logger.WriteToWorkBook(kontoutdragInfoForSave.excelFileSavePath, kontoutdragInfoForSave.sheetName, true, logThis);
        ...
        const string LÖNEKONTOName = "LÖNEKONTO";
        const string AllkortName = "Allkort";
        const string EjFaktureratEtcName = "ejFaktureratEtc";

        /// <summary>
        /// Sparar till Excel-fil
        /// </summary>
        public static LoadOrSaveResult GetAllEntriesFromExcelFile(KontoutdragInfoForLoad kontoutdragInfoForLoad,
        ...
        public static Hashtable LoadEntriesFromFile(KontoutdragInfoForLoad kontoutdragInfoForLoad, ref Thread workerThread)
        {
            ...
            try
            {
                ...
                if (filePath == "")
                    kontoutdragInfoForLoad.excelFileSavePath = filePath = FileOperations.OpenFileOfType("Open file", FileType.xls, "");//Öppnar dialog
        ...
        private static LoadOrSaveResult SkapaKontoEntries(SortedList saveToTable, Hashtable entriesLoadedFromDataStore
            , Dictionary<string, string> saldon)
        {
                ...
                if (item.Value != null)
                {
                    ...
                    if (entryArray[0] == "y")
                    {
                        ...
                        else if (ProgramSettings.BankType == BankType.Mobilhandelsbanken)
                        {
                            ...
                            saldon.AddToOrChangeValueInDictionaryForKey(EjFaktureratEtcName,
                                    saldoAllkortKreditEjFakturerat.GetValueFromEntry()
        ...
        internal static bool GetAllVisibleEntriesFromWebBrowser(
            SortedList kontoEntries, WebBrowser webBrowser1,
            SortedList newKontoEntries, ref bool somethingChanged,
            Dictionary<string, string> saldon)
        {
        ...
        private static void GetMobileHandelsBankenSaldo(HtmlElement saldoElement, Dictionary<string, string> saldon)
        {
            ...
            if (saldon.ContainsKey(AllkortName)
        ...
        private static BankRow GetSwedBankTableRow(HtmlElement htmlElement)
        {
            ...
            entryStrings.SaldoValue = htmlElement.Children.Count > saldoColNum && htmlElement.Children[saldoColNum] != null
        ...
        private static void AddNewEntryFromStringArray(BankRow entryStrings, SortedList kontoEntries, SortedList newKontoEntries, SortedList newBatchOfKontoEntriesAlreadyRed)
        {
            ...
            {//Om man hade entryn i Excel, innan laddning, och innan man gick igenom nya, så kan man (förutsätter att man då det inte finns saldo (i allkort-kredit), så läses hela listan in i ett svep, det är inte en lista, det kan ev. bli dubblet om två datum hamnar på olika allkort-kredit-fakturor)
                var userDecision = MessageBox.Show("Found potential double: " + newKeyFromHtml.KeyForThis,
