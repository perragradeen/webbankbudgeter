...
namespace BudgetterarnDAL.WebCrawlers
{
    public class EntryAdder
    {
        ...
        private readonly Func<string[], int> _writeLineToMessageBox;

        private SortedList newBatchOfKontoEntriesAlreadyRed;

        public EntryAdder(
            KontoEntriesHolder kontoEntriesHolder,
            Func<string[], int> writeLineToMessageBox)
        {
            this.kontoEntriesHolder = kontoEntriesHolder;
            _writeLineToMessageBox = writeLineToMessageBox;
        }
        ...
        private void HandlePotientialDouble(KontoEntry entryNewFromHtml)
        {
            ...
            var userDecision = _writeLineToMessageBox( //MessageBox.Show(
                new string[] {
